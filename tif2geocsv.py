...
if __name__ == "__main__":
    image_path = '/Users/lixiwang/Desktop/二维-2D/5cm-正射影像-2D-53pic-成果-result/map/result.tif'
    srcImage = gdal.Open(image_path, gdal.GA_ReadOnly)
    geoTrans = srcImage.GetGeoTransform()
    print(geoTrans)
    print(f"GetProjection: {srcImage.GetProjection()}")